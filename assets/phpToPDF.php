...
define("API_KEY", "273fe0f86284d0a5427b14e98a6a7be999124882");
//////////////////////////////////////////////////////////////////////////////////
...
define("PHPTOPDF_API", "v2.3.16.0");                                    //API version - DO NOT MODIFY THIS OR PDF WILL NOT WORK
...
function phptopdf($pdf_options)
{
    ...
    } else if(isset($pdf_options['ssl']) == 'yes' && $pdf_options['beta'] == 'yes') {
