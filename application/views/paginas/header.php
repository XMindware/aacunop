        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><?=anchor(base_url().'Config', 'General Setup')?></li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><?=anchor(base_url().'Timeswitch/Pending', 'Shift Change List')?></li>
              <li role="separator" class="divider"></li>
              <li><?=anchor(base_url().'Agentes', 'Agent List')?></li>
              <li><?=anchor(base_url().'Castigados', 'Non Compliant Agents')?></li>
              <li><?=anchor(base_url().'Descansos', 'Days Off')?></li>        
              <li><?=anchor(base_url().'Puestos', 'Positions')?></li>
              ...
              <li><?=anchor(base_url().'Polls', 'Polls')?></li>
            </ul>
          </li>
